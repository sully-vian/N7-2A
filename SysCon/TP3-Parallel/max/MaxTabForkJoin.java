    ...
    static class PartialMax extends RecursiveTask<Integer> {
        ...
        public Integer compute() {
            ...
            if ((end - start) > threshold) {
                ...
                PartialMax sp1 = new PartialMax(array, start, middle, threshold);
                PartialMax sp2 = new PartialMax(array, middle, end, threshold);
                max = Math.max(sp1.compute(), sp2.compute());
            } else {
                max = LargeIntArray.max(array, start, end);
            }
