...
public class Main {
  ...
  static void setSleepDuration(int freql, int freqr) {
    ...
    if (verbose)
      System.out.println("Lecteur: Delai pense =" + MinDelayLRien + "-" + MaxDelayLRien + ", utilise = " + MinDelayLit
          + "-" + MaxDelayLit);
    switch (freqr) {
      case 0: /* Peu gourmands */
    ...
    if (verbose)
      System.out.println("Redacteur: Delai pense =" + MinDelayERien + "-" + MaxDelayERien + ", utilise = "
          + MinDelayEcrit + "-" + MaxDelayEcrit);
