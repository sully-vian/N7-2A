...
\begin{figure}[ht]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        portée      & faible densité & moyenne densité & haute densité \\
        \hline\hline
        $20 000$ km & $3.50$         & $5.04$          & $3.99$        \\
        \hline
        $40 000$ km & $2.86$         & $2.74$          & $2.78$        \\
        \hline
        $60 000$ km & $1.90$         & $1.90$          & $1.96$        \\
        \hline
    \end{tabular}
    \caption{Moyennes des longueurs des plus courts chemins}
    \label{tab:shortest-path-mean}
\end{figure}

Les histogrammes de la répartition des longueurs des plus courts chemins (figure \ref{fig:shortest-path-hist}) sont très pertinents. On y voit que l'augmentation de la portée fait "disparaitre" certaines valeurs. Comme si les "distances"\footnote{Ici, la longueur d'un chemin vaut le nombre d'arêtes parcourues.} étaient contenues dans des intervalles. On suppose que les trajets de longueur semblables se ressemblent et ont des portions communes. C'est une forme primitive d'optimisation, des "autoroutes"(portions de chemin "arrangeantes") se créent.
