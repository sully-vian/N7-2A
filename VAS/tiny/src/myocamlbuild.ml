...
let apron_lib =
  "-lboxMPQ_caml -lboxMPQ -loctMPQ_caml -loctMPQ  -lpolkaMPQ_caml -lpolkaMPQ_debug \
   -lapron_caml -lapron -lgmp_caml -lmpfr -lgmp -lbigarray -lcamlidl"
;;
