...
public class SimplePDLValidator extends SimplepdlSwitch<Boolean> {
	...
	public Boolean caseWorkSequence(WorkSequence object) {
		...
		this.result.recordIfFailed(
				...
				.allMatch(pe -> (pe.equals(object) ||
						         !((WorkSequence) pe).getPredecessor().equals(object.getPredecessor()) ||
						         !((WorkSequence) pe).getSuccessor().equals(object.getSuccessor()) ||
						         !((WorkSequence) pe).getLinkType().equals(object.getLinkType()))),
				object,
				"Il y a deux dépendances de type " + object.getLinkType() + " entre " + object.getPredecessor().getName()
	...
	public Boolean caseGuidance(Guidance object) {
		// contrainte sur guidance: text != null
		this.result.recordIfFailed(
				object.getText() != null,
				object,
				"Une guidance doit avoir un texte non vide.");
		return null;
	}
