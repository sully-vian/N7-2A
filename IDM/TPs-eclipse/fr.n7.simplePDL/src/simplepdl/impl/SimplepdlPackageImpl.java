...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getProcess_Activities(), this.getWorkDefinition(), null, "activities", null, 1, -1, simplepdl.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
