...
- [ ] Implanter les règles de typage vues en TD et rappelées dans le  fichier [`regles-typage.pdf`](regles-typage.pdf), en complétant le fichier [`Types.ml`](Types.ml) et en décommentant l'appel au typage dans le [`Main.ml`](Main.ml)
