...
let%test _ = print_endline "tests" = ()
...
let%test _ = getValeur (miniML "../../exemples/exemple-14.mml") = IntegerValue 2
let%test _ = getValeur (miniML "../../exemples/exemple-15.mml") = IntegerValue 3
let%test _ = getValeur (miniML "../../exemples/exemple-16.mml") = IntegerValue 3
let%test _ = getValeur (miniML "../../exemples/exemple-17.mml") = IntegerValue 0
let%test _ = getValeur (miniML "../../exemples/exemple-18.mml") = IntegerValue 0
