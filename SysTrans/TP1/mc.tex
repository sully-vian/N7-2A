...
\@x{}\moduleLeftDash\@xx{ {\MODULE} mc}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} numMiss ,\, numCan}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME} numMiss \.{\in} Nat \.{\land} numCan \.{\in} Nat}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} missG ,\,}%
\@x{\@s{16.4} missD ,\,}%
...
\@x{\@s{16.4} barque}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq} {\Box} ( barque \.{\in} \{\@w{G} ,\,\@w{D} \} )}%
\@pvspace{8.0pt}%
\@x{ NombreOK \.{\defeq} {\Box} (}%
\@x{\@s{16.4} \.{\land} missG \.{+} missD \.{=} numMiss}%
\@x{\@s{16.4} \.{\land} canG \.{+} canD \.{=} numCan}%
\@x{ )}%
\@pvspace{8.0pt}%
\@x{ pasMiam \.{\defeq}}%
\@x{\@s{16.4} \.{\land} missG \.{>} 0 \.{\implies} missG \.{\geq} canG}%
 \@x{\@s{16.4} \.{\land} missD\@s{0.11} \.{>} 0 \.{\implies} missD\@s{0.11}
 \.{\geq} canD}%
\@pvspace{8.0pt}%
\@x{ ToujoursOK \.{\defeq} {\Box} pasMiam}%
\@pvspace{8.0pt}%
\@x{ Solution \.{\defeq}}%
 \@x{\@s{16.4} {\Box} {\neg} ( missD \.{=} numMiss \.{\land} canD \.{=} numCan
 )}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 prédicats sur la \ensuremath{barque
}}%
\@xx{}%
\@x{ barqueGD \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barque \.{=}\@w{G}}%
\@x{\@s{16.4} \.{\land} barque \.{'} \.{=}\@w{D}}%
\@pvspace{8.0pt}%
\@x{ barqueDG \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barque \.{=}\@w{D}}%
\@x{\@s{16.4} \.{\land} barque \.{'} \.{=}\@w{G}}%
...
\@xx{}%
\@x{ missGD1 \.{\defeq}}%
\@x{\@s{16.4} \.{\land} missG \.{'} \.{=} missG \.{-} 1}%
\@x{\@s{16.4} \.{\land} missD \.{'}\@s{0.11} \.{=} missD\@s{0.11} \.{+} 1}%
\@pvspace{8.0pt}%
\@x{ missGD2 \.{\defeq}}%
\@x{\@s{16.4} \.{\land} missG \.{'} \.{=} missG \.{-} 2}%
\@x{\@s{16.4} \.{\land} missD \.{'}\@s{0.11} \.{=} missD\@s{0.11} \.{+} 2}%
\@pvspace{8.0pt}%
\@x{ missDG1 \.{\defeq}}%
\@x{\@s{16.4} \.{\land} missD \.{'}\@s{0.11} \.{=} missD\@s{0.11} \.{-} 1}%
\@x{\@s{16.4} \.{\land} missG \.{'} \.{=} missG \.{+} 1}%
...
\@xx{}%
\@x{ canGD1 \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{8.53} canG \.{'} \.{=} canG \.{-} 1}%
 \@x{\@s{16.4} \.{\land}\@s{8.53} canD \.{'}\@s{0.11} \.{=} canD\@s{0.11}
 \.{+} 1}%
\@pvspace{8.0pt}%
\@x{ canGD2 \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{8.53} canG \.{'} \.{=} canG \.{-} 2}%
 \@x{\@s{16.4} \.{\land}\@s{8.53} canD \.{'}\@s{0.11} \.{=} canD\@s{0.11}
 \.{+} 2}%
\@pvspace{8.0pt}%
\@x{ canDG1 \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{8.46} canD \.{'}\@s{0.11} \.{=} canD\@s{0.11}
 \.{-} 1}%
\@x{\@s{16.4} \.{\land}\@s{8.46} canG \.{'} \.{=} canG \.{+} 1}%
\@pvspace{8.0pt}%
\@x{ canDG2 \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{8.46} canD \.{'}\@s{0.11} \.{=} canD\@s{0.11}
 \.{-} 2}%
\@x{\@s{16.4} \.{\land}\@s{8.46} canG \.{'} \.{=} canG \.{+} 2}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} missG \.{=} numMiss}%
\@x{\@s{16.4} \.{\land} missD\@s{0.11} \.{=} 0}%
\@x{\@s{16.4} \.{\land} canG \.{=} numCan}%
\@x{\@s{16.4} \.{\land} canD\@s{0.11} \.{=} 0}%
\@x{\@s{16.4} \.{\land} barque \.{=}\@w{G}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 1 missionaire \ensuremath{G \.{\rightarrow} D
}}%
\@xx{}%
\@x{ bougerM\_GD \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueGD}%
\@x{\@s{16.4} \.{\land} missG \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} missGD1}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} canG ,\, canD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 2 missionaires \ensuremath{G \.{\rightarrow} D
}}%
\@xx{}%
\@x{ bougerMM\_GD \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueGD}%
\@x{\@s{16.4} \.{\land} missG \.{\geq} 2}%
\@x{\@s{16.4} \.{\land} missGD2}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} canG ,\, canD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 1 cannibale \ensuremath{G \.{\rightarrow} D
}}%
\@xx{}%
\@x{ bougerC\_GD \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueGD}%
\@x{\@s{16.4} \.{\land} canG \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} canGD1}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} missG ,\, missD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 2 cannibales \ensuremath{G \.{\rightarrow} D
}}%
\@xx{}%
\@x{ bougerCC\_GD \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueGD}%
\@x{\@s{16.4} \.{\land} canG \.{\geq} 2}%
\@x{\@s{16.4} \.{\land} canGD2}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} missG ,\, missD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 1 de chaque \ensuremath{G \.{\rightarrow} D
}}%
\@xx{}%
\@x{ bougerMC\_GD \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueGD}%
\@x{\@s{16.4} \.{\land} missG \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} canG \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} missGD1}%
...
\@x{}%
\@y{\@s{0}%
 Bouger 1 missionaire \ensuremath{D \.{\rightarrow} G
}}%
\@xx{}%
\@x{ bougerM\_DG \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueDG}%
\@x{\@s{16.4} \.{\land} missD \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} missDG1}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} canG ,\, canD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 2 missionaires \ensuremath{D \.{\rightarrow} G
}}%
\@xx{}%
\@x{ bougerMM\_DG \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueDG}%
\@x{\@s{16.4} \.{\land} missD \.{\geq} 2}%
\@x{\@s{16.4} \.{\land} missDG2}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} canG ,\, canD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 1 cannibale \ensuremath{D \.{\rightarrow} G
}}%
\@xx{}%
\@x{ bougerC\_DG \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueDG}%
\@x{\@s{16.4} \.{\land} canD \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} canDG1}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} missG ,\, missD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 2 cannibales \ensuremath{D \.{\rightarrow} G
}}%
\@xx{}%
\@x{ bougerCC\_DG \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueDG}%
\@x{\@s{16.4} \.{\land} canD \.{\geq} 2}%
\@x{\@s{16.4} \.{\land} canDG2}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} missG ,\, missD {\rangle}}%
\@x{\@s{16.4} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Bouger 1 de chaque \ensuremath{D \.{\rightarrow} G
}}%
\@xx{}%
\@x{ bougerMC\_DG \.{\defeq}}%
\@x{\@s{16.4} \.{\land} barqueDG}%
\@x{\@s{16.4} \.{\land} missD \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} canD \.{\geq} 1}%
\@x{\@s{16.4} \.{\land} missDG1}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} bougerM\_GD}%
\@x{\@s{16.4} \.{\lor} bougerMM\_GD}%
\@x{\@s{16.4} \.{\lor} bougerC\_GD}%
\@x{\@s{16.4} \.{\lor} bougerCC\_GD}%
\@x{\@s{16.4} \.{\lor} bougerMC\_GD}%
\@x{\@s{16.4} \.{\lor} bougerM\_DG}%
\@x{\@s{16.4} \.{\lor} bougerMM\_DG}%
\@x{\@s{16.4} \.{\lor} bougerC\_DG}%
\@x{\@s{16.4} \.{\lor} bougerCC\_DG}%
\@x{\@s{16.4} \.{\lor} bougerMC\_DG}%
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} missG ,\,
 missD ,\, canG ,\, canD ,\, barque {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
