...
\@x{}\moduleLeftDash\@xx{ {\MODULE} philosophes0}\moduleRightDash\@xx{}%
\@x{}%
\@y{\@s{0}%
 Philosophes. Version en utilisant \ensuremath{l\.{'}}état des voisins.
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Naturals}%
...
\@x{ {\CONSTANT} N}%
\@pvspace{8.0pt}%
\@x{ Philos \.{\defeq} 0 \.{\dotdot} N \.{-} 1}%
\@pvspace{8.0pt}%
\@x{ gauche ( i ) \.{\defeq} ( i \.{+} 1 ) \.{\%} N\@s{37.69}}%
\@y{\@s{0}%
 philosophe à gauche du philo n°\ensuremath{i
}}%
\@xx{}%
 \@x{ droite ( i )\@s{4.47} \.{\defeq} ( i \.{+} N \.{-} 1 ) \.{\%}
 N\@s{16.39}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} {\Box} ( etat \.{\in} [ Philos \.{\rightarrow} \{
...
\@xx{}%
 \@x{ ExclMutuelle \.{\defeq} {\Box} ( \A\, i \.{\in} Philos \.{:} ( etat [ i
 ] \.{\defeq} Eating ) \.{\implies}}%
 \@x{\@s{16.4} ( etat [ gauche ( i ) ] \.{\neq} Eating \.{\land} etat [ droite
 ( i ) ] \.{\neq} Eating ) )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{ VivaciteIndividuelle \.{\defeq}}%
 \@x{\@s{16.4} \A\, i \.{\in} Philos \.{:}\@s{4.1} etat [ i ] \.{\defeq}
 Hungry \.{\leadsto} etat [ i ] \.{\defeq} Eating}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 vivacité globale
...
\@x{ VivaciteGlobale \.{\defeq}}%
 \@x{\@s{16.4} ( \E\, i \.{\in} Philos \.{:} etat [ i ] \.{\defeq} Hungry )
 \.{\leadsto} ( \E\, j \.{\in} Philos \.{:} etat [ j ] \.{\defeq} Eating )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} etat \.{=} [ i \.{\in} Philos \.{\mapsto} Thinking ]}%
\@pvspace{8.0pt}%
\@x{ demander ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} etat [ i ] \.{=} Thinking}%
 \@x{\@s{16.4} \.{\land} etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ] \.{=}
 Hungry ]}%
\@pvspace{8.0pt}%
\@x{ manger ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} etat [ i ] \.{=} Hungry}%
 \@x{\@s{16.4} \.{\land} etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ] \.{=}
 Eating ]}%
\@x{\@s{16.4} \.{\land} etat [ gauche ( i ) ] \.{\neq} Eating}%
\@x{\@s{16.4} \.{\land} etat [ droite ( i ) ]\@s{4.47} \.{\neq} Eating}%
\@pvspace{8.0pt}%
\@x{ penser ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} etat [ i ] \.{=} Eating}%
 \@x{\@s{16.4} \.{\land} etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ] \.{=}
 Thinking ]}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{8.2} \E\, i \.{\in} Philos \.{:} \.{\lor} demander ( i )}%
\@x{\@s{68.71} \.{\lor} manger ( i )}%
\@x{\@s{68.71} \.{\lor} penser ( i )}%
\@pvspace{8.0pt}%
\@x{ Fairness \.{\defeq} {\TRUE}}%
\@y{\@s{0}%
 À changer
}%
\@xx{}%
...
\@x{\@s{8.2} \.{\land}\@s{0.16} {\Box} [ Next ]_{ {\langle} etat {\rangle}}}%
\@x{\@s{8.2} \.{\land}\@s{0.16} Fairness}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
