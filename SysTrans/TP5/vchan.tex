...
\@x{\@s{71.04} \.{\land} SenderState \.{'} \.{=} Done}%
 \@x{\@s{71.04} \.{\land} {\UNCHANGED} {\langle} Sent ,\, Got ,\, SenderLive
...
\@x{\@s{79.60}}%
\@y{\@s{0}%
 \ensuremath{k \.{=} nb} d\mbox{'}octets dans \ensuremath{msg
}}%
\@xx{}%
\@x{\@s{96.00} \.{\land} k \.{\leq} BufferSize \.{-} Len ( Buffer )}%
\@y{\@s{0}%
 on \ensuremath{n\.{'}}écrit pas plus que la place dispo
}%
\@xx{}%
...
\@xx{}%
\@x{ SenderUnblock2 \.{\defeq} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ SenderEnd \.{\defeq} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@x{ ReceiverIdle3 \.{\defeq} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@y{\@s{0}%
 copier le début du buffer
}%
\@xx{}%
\@x{\@s{92.27} \.{\land} Buffer \.{'} \.{=} Drop ( Buffer ,\, k )}%
\@y{\@s{0}%
 vider le buffer des \ensuremath{k} premiers
}%
\@xx{}%
...
\@xx{}%
\@x{ ReceiverEnd \.{\defeq} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@x{ SenderClose \.{\defeq} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ ReceiverClose \.{\defeq} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\end{cpar}%
\end{lcom}%
\@x{ Availability \.{\defeq}}%
 \@x{\@s{8.2} \A\, x \.{\in} 0 \.{\dotdot} Cardinality ( Byte ) \.{:} x \.{=}
 Len ( Sent ) \.{\land} SenderState \.{=} Idle \.{\leadsto} ( Len ( Got )
 \.{\geq} x )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ NoLoss \.{\defeq} {\Diamond} {\Box} ( Got \.{=} Sent )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
