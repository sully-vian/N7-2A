...
\@x{}\moduleLeftDash\@xx{ {\MODULE} jeton}\moduleRightDash\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{12.29} {\Box} ( \.{\land} etat \.{\in} [ Processus \.{\rightarrow} \{
 Hungry ,\, Thinking ,\, Eating \} ]}%
\@x{\@s{23.87} \.{\land} jeton \.{\in} Processus )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{ JetonVaPartout \.{\defeq}}%
 \@x{\@s{16.4} \A\, i \.{\in} Processus \.{:} {\Box} {\Diamond} ( jeton \.{=}
 i )}%
\@pvspace{8.0pt}%
\@x{ Sanity \.{\defeq}}%
 \@x{\@s{8.2} {\Box} ( \A\, i \.{\in} Processus \.{:} etat [ i ] \.{=} Eating
 \.{\implies} jeton \.{=} i )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
...
\@x{\@s{4.1} \.{\land} jeton \.{\in} Processus}%
\@pvspace{8.0pt}%
\@x{ demander ( i ) \.{\defeq}}%
...
\@x{\@s{8.2} \.{\land} jeton \.{=} i}%
 \@x{\@s{8.2} \.{\land} etat \.{'}\@s{2.37} \.{=} [ etat {\EXCEPT} {\bang} [ i
 ] \.{=} Eating ]}%
\@x{\@s{8.2} \.{\land} {\UNCHANGED} jeton}%
\@pvspace{8.0pt}%
\@x{ sortir ( i ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} etat [ i ] \.{=} Eating}%
 \@x{\@s{8.2} \.{\land} etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ] \.{=}
 Thinking ]}%
\@x{\@s{8.2} \.{\land} jeton \.{'} \.{=} ( i \.{+} 1 ) \.{\%} N}%
\@y{\@s{0}%
 ajout pour supprimer \ensuremath{SF(bouger(i))
}}%
\@xx{}%
\@x{}%
\@y{\@s{5.0}%
 \ensuremath{\.{\land} {\UNCHANGED} jeton \.{\,\backslash\,}}* modif pour
 supprimer \ensuremath{SF(bouger(i))
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ bouger ( i ) \.{\defeq}}%
...
\@x{\@s{8.2} \.{\land} etat [ i ] \.{\neq} Hungry}%
\@y{\@s{0}%
 ajout pour supprimer \ensuremath{SF(entrer(i))
}}%
\@xx{}%
