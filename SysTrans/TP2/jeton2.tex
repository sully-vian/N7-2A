...
\@x{}\moduleLeftDash\@xx{ {\MODULE} jeton2}\moduleRightDash\@xx{}%
\@x{}%
\@y{\@s{0}%
 Time-stamp: \ensuremath{\.{<}09} oct 2024 11:55 \ensuremath{Philippe}
 \ensuremath{Queinnec\.{>}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Algorithme d\mbox{'}exclusion mutuelle à base de \ensuremath{jeton\.{-}}
 version avec un tableau pour \ensuremath{jeton
}}%
\@xx{}%
\@pvspace{8.0pt}%
...
\@x{ {\CONSTANT} N}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME} N \.{\in} Nat \.{\land} N \.{>} 1}%
\@pvspace{8.0pt}%
\@x{ Processus \.{\defeq} 0 \.{\dotdot} N \.{-} 1}%
\@pvspace{8.0pt}%
\@x{ Hungry \.{\defeq}\@w{H}}%
\@x{ Thinking \.{\defeq}\@w{T}}%
\@x{ Eating \.{\defeq}\@w{E}}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{8.2} etat ,\,}%
...
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{12.29} {\Box} ( \.{\land} etat \.{\in} [ Processus\@s{5.39}
 \.{\rightarrow} \{ Hungry ,\, Thinking ,\, Eating \} ]}%
 \@x{\@s{23.87} \.{\land} jeton \.{\in} [ Processus \.{\rightarrow} {\BOOLEAN}
 ] )}%
\@y{\@s{0}%
 \ensuremath{jeton} est un tableau de booléens
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 un processus max a le \ensuremath{jeton
}}%
\@xx{}%
\@x{ ExclMutuelle \.{\defeq}}%
 \@x{\@s{16.4} {\Box} ( \A\, i ,\, j \.{\in} Processus \.{:} ( etat [ i ]
 \.{=} Eating \.{\land} etat [ j ] \.{=} Eating ) \.{\implies} ( i \.{=} j )
 )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ VivaciteIndividuelle \.{\defeq}}%
 \@x{\@s{16.4} \A\, i \.{\in} Processus \.{:} ( etat [ i ] \.{=} Hungry
 \.{\leadsto} etat [ i ] \.{=} Eating )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 si un processus demande, un processus obtiendra plus tard (pas forcément le
 même)
}%
\@xx{}%
\@x{ VivaciteGlobale \.{\defeq}}%
 \@x{\@s{16.4} ( \E\, i \.{\in} Processus \.{:} etat [ i ] \.{=} Hungry )
 \.{\leadsto} ( \E\, j \.{\in} Processus \.{:} etat [ j ] \.{=} Eating )}%
\@pvspace{8.0pt}%
\@x{ JetonVaPartout \.{\defeq}}%
 \@x{\@s{16.4} \A\, i \.{\in} Processus \.{:} {\Box} {\Diamond} ( jeton [ i ]
 )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Le \ensuremath{jeton} est un tableau, on doit vérif qu\mbox{'}il est unique
}%
\@xx{}%
\@x{ JetonUnique \.{\defeq}}%
 \@x{\@s{16.4} {\Box} ( \A\, i ,\, j \.{\in} Processus \.{:} ( jeton [ i ]
 \.{\land} jeton [ j ] ) \.{\implies} ( i \.{=} j ) )}%
\@pvspace{8.0pt}%
\@x{ Sanity \.{\defeq}}%
 \@x{\@s{16.4} {\Box}\@s{4.61} ( \A\, i \.{\in} Processus \.{:} etat [ i ]
 \.{=} Eating \.{\implies} jeton [ i ] )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{4.1} \.{\land} etat \.{=} [ i \.{\in} Processus \.{\mapsto} Thinking
 ]}%
 \@x{\@s{4.1} \.{\land} \E\, j\@s{5.56} \.{\in} Processus \.{:} jeton \.{=} [
 i \.{\in} Processus \.{\mapsto} i \.{=} j ]}%
\@y{\@s{0}%
 génie
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ demander ( i ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} etat [ i ] \.{=} Thinking}%
 \@x{\@s{8.2} \.{\land} etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ] \.{=}
 Hungry ]}%
\@x{\@s{8.2} \.{\land} {\UNCHANGED} jeton}%
\@pvspace{8.0pt}%
\@x{ entrer ( i ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} etat [ i ] \.{=} Hungry}%
\@x{\@s{8.2} \.{\land} jeton [ i ]}%
 \@x{\@s{8.2} \.{\land} etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ] \.{=}
 Eating ]}%
\@x{\@s{8.2} \.{\land} {\UNCHANGED} jeton}%
\@pvspace{8.0pt}%
\@x{ sortir ( i ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} etat [ i ] \.{=} Eating}%
 \@x{\@s{8.2} \.{\land} etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ] \.{=}
 Thinking ]}%
\@x{\@s{8.2}}%
\@y{\@s{0}%
 ``déplacer'' le \ensuremath{jeton} de \ensuremath{i} à
 (\ensuremath{i\.{+}1)\.{\%}N
}}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} jeton \.{'} \.{=} [ jeton {\EXCEPT} {\bang} [ i ]
 \.{=} {\FALSE} ,\, {\bang} [ ( i \.{+} 1 ) \.{\%} N ] \.{=} {\TRUE} ]}%
\@pvspace{8.0pt}%
\@x{ bouger ( i ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} jeton [ i ]}%
\@x{\@s{8.2} \.{\land} etat [ i ] \.{\neq} Eating}%
...
\@xx{}%
 ...
 \.{=} {\FALSE} ,\, {\bang} [ ( i \.{+} 1 ) \.{\%} N ] \.{=} {\TRUE} ]}%
\@x{\@s{8.2} \.{\land} etat [ i ] \.{\neq} Hungry}%
\@x{\@s{8.2} \.{\land} {\UNCHANGED} etat}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{4.1} \E\, i \.{\in} Processus \.{:}}%
\@x{\@s{11.32} \.{\lor} demander ( i )}%
\@x{\@s{11.32} \.{\lor} entrer ( i )}%
\@x{\@s{11.32} \.{\lor} sortir ( i )}%
\@x{\@s{11.32} \.{\lor} bouger ( i )}%
\@pvspace{8.0pt}%
\@x{ Fairness \.{\defeq} \A\, i \.{\in} Processus \.{:}}%
 \@x{\@s{64.46} \.{\land} {\WF}_{ {\langle} etat ,\, jeton {\rangle}} ( entrer
 ( i ) )}%
 \@x{\@s{64.46} \.{\land} {\WF}_{ {\langle} etat ,\, jeton {\rangle}} ( sortir
 ( i ) )}%
 \@x{\@s{64.46} \.{\land} {\WF}_{ {\langle} etat ,\, jeton {\rangle}} ( bouger
 ( i ) )}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq}}%
\@x{\@s{4.1} \.{\land} Init}%
\@x{\@s{4.1} \.{\land} {\Box} [ Next ]_{ {\langle} etat ,\, jeton {\rangle}}}%
\@x{\@s{4.1} \.{\land} Fairness}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
