...
void dtrsm_(char *side, char *uplo, char *transa, char *diag, int *m, int *n,
            const double *alpha, const double *A, int *lda, double *B,
            int *ldb);
...
void dgemv_(char *t, int *m, int *n, const double *alpha, const double *A,
            int *lda, const double *x, int *incx, const double *beta, double *y,
            int *incy);
double dnrm2_c(int n, double *x, int incx);
double dnrmf_c(int m, int n, double *A, int lda);

void dgemm_(char *ta, char *tb, int *m, int *n, int *k, const double *alpha,
            const double *A, int *lda, const double *B, int *ldB,
            const double *beta, const double *c, int *ldc);

void dsymm_(char *side, char *uplo, int *m, int *n, const double *alpha,
            const double *A, int *lda, const double *B, int *ldB,
            const double *beta, const double *c, int *ldc);

void dsyrk_(char *uplo, char *trans, int *n, int *k, const double *alpha,
            const double *A, int *lda, const double *beta, const double *c,
            int *ldc);
