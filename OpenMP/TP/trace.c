...
#pragma omp master
  {
    ...
    for (t = 0; t < MAXTHREADS; t++) {
      for (e = 0; e < nevents[t]; e++) {
        ...
        fprintf(pFile,
                ...
                (double)(ev.t_start - t_zero) / scale_x, ((double)t) / scale_y,
    ...
    for (t = 0; t < nth; t++) {
      fprintf(
          pFile,
          "<text x=\"%f\" y=\"%f\" style=\"font-size:6pt\">Thread %d</text>\n",
    ...
    fprintf(
        pFile,
        "<text x=\"0\" y=\"%f\" style=\"font-size:6pt\">Time (usec.)</text>\n",
    ...
    for (x = ((double)t_stop - t_zero) / scale_x / 10.0;
      ...
      fprintf(pFile,
              "<text x=\"%f\" y=\"%f\" style=\"font-size:6pt\"> %.0f </text>\n",
